...
//    cout << endl;
    cout << "Write count     : " << wr_cnt << endl;
    cout << " Read count     : " << rd_cnt << endl;
    cout << "Read from cache : " << rd_cache_cnt << endl;
    cout << "Read from buffer: " << rd_buf_cnt << endl;
